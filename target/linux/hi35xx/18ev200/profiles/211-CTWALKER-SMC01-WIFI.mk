...
define Profile/CTWALKER_SMC01_WIFI
  NAME:=CTWALKER-SMC01-WIFI
...
define Profile/CTWALKER_SMC01_WIFI/Description
	CT IP camera with wifi, model: SMC01, based on HI3518EV200
endef
$(eval $(call Profile,CTWALKER_SMC01_WIFI))