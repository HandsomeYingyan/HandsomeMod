...
# TODO: Separate Package kmod-video-core 
# TODO: kmod-video-csi-core 
...
define KernelPackage/video-core
  ...
  DEPENDS:=@PCI_SUPPORT||USB_SUPPORT||TARGET_sunxi +PACKAGE_kmod-i2c-core:kmod-i2c-core
  KCONFIG:= \
...
define KernelPackage/video-gspca-core
  ...
  DEPENDS:=@USB_SUPPORT +kmod-usb-core +kmod-input-core +LINUX_5_4:kmod-video-videobuf2
...
define KernelPackage/video-ov2685
...
define KernelPackage/video-ov2685/description
 OmniVision ov2685 sensor support
endef

$(eval $(call KernelPackage,video-ov2685))
...
define KernelPackage/video-ov5670
...
define KernelPackage/video-ov5670/description
 OmniVision ov5670 sensor support
endef

$(eval $(call KernelPackage,video-ov5670))

define KernelPackage/video-ov5675
...
define KernelPackage/video-ov5675/description
 OmniVision ov5675 sensor support
endef

$(eval $(call KernelPackage,video-ov5675))

define KernelPackage/video-ov7251
...
define KernelPackage/video-ov7251/description
 OmniVision ov7251 sensor support
endef

$(eval $(call KernelPackage,video-ov7251))

define KernelPackage/video-ov8856
...
define KernelPackage/video-ov8856/description
 OmniVision ov8856 sensor support
endef

$(eval $(call KernelPackage,video-ov8856))

define KernelPackage/video-ov9650
...
define KernelPackage/video-ov9650/description
 OmniVision ov9650 sensor support
endef

$(eval $(call KernelPackage,video-ov9650))

define KernelPackage/video-ov13858
...
define KernelPackage/video-ov13858/description
 OmniVision ov13858 sensor support
endef

$(eval $(call KernelPackage,video-ov13858))

define KernelPackage/video-mt9m001
...
define KernelPackage/video-mt9m001/description
 mt9m001 sensor support
endef

$(eval $(call KernelPackage,video-mt9m001))

define KernelPackage/video-mt9m032
...
define KernelPackage/video-mt9m032/description
 mt9m032 sensor support
endef

$(eval $(call KernelPackage,video-mt9m032))

define KernelPackage/video-mt9p031
...
define KernelPackage/video-mt9p031/description
 mt9p031 sensor support
endef

$(eval $(call KernelPackage,video-mt9p031))

define KernelPackage/video-mt9t001
...
define KernelPackage/video-mt9t001/description
 mt9t001 sensor support
endef

$(eval $(call KernelPackage,video-mt9t001))
